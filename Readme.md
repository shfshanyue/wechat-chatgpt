...
个人基于 ChatGPT 的飞书、钉钉、企微内部应用、公众号、个人微信、企业微信的 SaaS 平台已上线，有部署需求的同学可以联系我 `shanyue-bot` 。
...
如需协助部署，或者二次开发定制服务，可添加微信。如需技术交流，可添加微信或者进入飞书群。

个人基于 ChatGPT 的飞书、钉钉、企微内部应用、公众号、个人微信、企业微信的 SaaS 平台已上线，有部署需求的同学可以联系我。
